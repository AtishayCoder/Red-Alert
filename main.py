...
def display_message(h, s):
    screen.draw.text(h, fontsize=60, center=CENTRE, color=FONT_COLOR)
    screen.draw.text(s, fontsize=30, center=(CENTRE_X, CENTRE_Y + 30), color=FONT_COLOR)    
